    ...
    const Utils = {
      ...
      showNotification(message, type = 'success') {
        ...
        notification.className = `fixed top-4 right-4 z-50 p-4 rounded-xl shadow-xl transition-all duration-300 transform translate-x-full ${
    ...
    // Lightbox for Gallery and Plantas
    ...
    function openLightbox(images, captions, startIndex) {
      ...
      document.getElementById('lightbox-caption').innerText = currentCaptions[currentImageIndex];
    ...
    const galleryCaptions = [
      'Fachada do Residencial Di Pietro',
      'Área de Lazer',
    ...
    function openGalleryLightbox(startIndex) {
      openLightbox(galleryImages, galleryCaptions, startIndex);
    }

    // Plantas Lightbox
    const plantasImages = [
      '/images/PLANTA HUMANIZADA  01.1.png',
      '/images/PLANTA HUMANIZADA  02.png',
      '/images/PLANTA HUMANIZADA  03.png'
    ];
    const plantasCaptions = [
      'Planta 27m² - Studio',
      'Planta 35m² - 1 Dormitório',
      'Planta 45m² - 2 Dormitórios'
    ];

    function openPlantasLightbox(startIndex) {
      openLightbox(plantasImages, plantasCaptions, startIndex);
    }
    ...
    class App {
      ...
      initializeComponents() {
        ...
        // new SwiperController(); // Não há swiper nesta página
        new FormController();
        new ScrollProgress();
      ...
      setupCustomEvents() {
        ...
        const cards = document.querySelectorAll('.benefit-card, .empreendimento-card, .diferencial-card');
        cards.forEach(card => {
